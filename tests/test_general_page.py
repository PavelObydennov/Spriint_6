...
class TestGeneralPage:
    ...
    def test_click_question(self, driver, question_method, answer_locator, expected_answer):
        # Инициализация страницы
        general_page = GeneralPage(driver)

        # Проверка вопроса и ответа
        general_page.verify_question_and_answer(question_method, answer_locator, expected_answer)